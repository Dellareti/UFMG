...
// Saida: vet
{
  ...
  //Aloca vetor
  vet->m = (double *)malloc(MAXTAM*sizeof(double));
...
// Saida: vet
{
  ...
  // Aloca vetor
  // vet = malloc(MAXTAM * sizeof(double));
...
void escreveElemento(vetor_tipo * vet, int pos, double m)
...
// Saida: vet
{
  ...
  // troca v por m
  //oid escreveElemento(vetor_tipo * vet, int pos, double m); era v antes
  vet->m[pos] = m;
}
