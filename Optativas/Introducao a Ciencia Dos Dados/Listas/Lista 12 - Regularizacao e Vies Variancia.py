...
beta = 0.1
theta_reg = np.ones(5)
theta_reg = gd_reg(theta_reg, derivadas_regressao_reg, X_train, y_train, beta)

r2_train = multiple_r_squared(X_train, y_train, theta_reg)
r2_test =  multiple_r_squared(X_test, y_test, theta_reg)

assert_equal(np.round(r2_train,4), np.round(0.7904,4))
assert_equal(np.round(r2_test,4), np.round(0.7236,4))
...
assert_equal(np.round(r2_test,4), np.round(0.7233,4))
