# -*- coding: utf-8 -*-
"""Lista 11 - Regressao Logistica.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jyklDq1J1DQoOJBdSOYGom04kqR07CYO
...
def derivadas(X, y, theta):
    return -((y - sigmoid(X, theta)) @ X) / len(y)
...
def sgd(X, y, lambda_=0.001, tol=0.01, max_iter=10000):
    ...
    for i in range(max_iter):
        ...
        X_r, y_r = X[r], y[r]
        X_r = X_r.reshape(1, len(X_r))
        grad = derivadas(X_r, np.array([y_r]), theta)
        theta_novo = theta - lambda_ * grad
